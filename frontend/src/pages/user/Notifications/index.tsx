  ...
  return (
    <div className="min-h-screen bg-gray-100 px-5 pb-14 pt-[2rem] md:px-10 lg:px-[20rem]">
      <div className="mx-auto max-w-[90rem]">
        <div className="mb-5 flex flex-col gap-4 rounded-xl border border-gray-200 bg-white p-6 md:flex-row md:items-center md:justify-between">
          <div>
        ...
        <div className="mb-5 flex rounded-xl border border-gray-200 bg-white p-1">
          {[
            ...
            <button
              ...
              className={`h-16 flex-1 rounded-lg px-4 text-[1.35rem] font-medium transition-colors ${
                filter === item.value
        ...
        {isLoading ? (
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-10 text-center">
            ...
            <p className="mt-2 text-gray-500">
              Các cập nhật về tin đăng, tin nhắn và đánh giá sẽ xuất hiện tại
              đây.
            </p>
          </div>
            ...
            {filteredNotifications.map((notification) => {
              ...
              return (
                <button
                  ...
                  className={`flex w-full gap-4 rounded-xl border p-5 text-left transition-colors hover:border-orange-200 hover:bg-orange-50 ${
                    notification.isRead
