...
export class AddPhoneVerificationType1780802898236 implements MigrationInterface {
    name = 'AddPhoneVerificationType1780802898236'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_verifications_type_enum" AS ENUM('register_email', 'change_email', 'reset_password', 'add_phone', 'change_phone')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_verifications_type_enum_old" AS ENUM('register_email', 'change_email', 'reset_password', 'phone_otp')`);
